...
const ItemPage: React.FC = () => {
    ...
    return (
        <div className="container min-w-full px-4 md:px-10 pb-4 md:pb-10 min-h-screen bg-transparent md:flex">
            ...
            <div className="flex flex-col flex-grow sm:mr-10 md:mx-10">
            ...
            <div className="bg-cyan-200 w-60 h-72 md:w-80 md:h-96 flex flex-col rounded-xl bg-opacity-20 items-left px-10 border-black border-2 border-opacity-20">
                <h1 className="text-base md:text-xl font-semibold my-5">Starting price: €{item.startingPrice}</h1>
                <h1 className="text-base md:text-xl font-semibold flex-grow">Current bid: €{item.currentBid}</h1>
                ...
                <Button ripple={true} variant="gradient" size="md" className="text-black py-1 lg:py-3 text-sm md:text-base h-50 bg-white mb-5 w-full flex items-center">
